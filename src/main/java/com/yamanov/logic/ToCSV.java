...
public class ToCSV extends IOException {
    ...
    public static boolean addToCSV(String csvPath, List<CommonItem> values)  {
        try (OutputStreamWriter file = new OutputStreamWriter(new FileOutputStream(csvPath, true), "Windows-1251")) {
